  ...
  const dictionary = [
    {
      word: "Reboot",
      definition:
        "- to turn off and start a computer or an electronic system again",
    ...
    },
    {
      ...
      sample:
        "The company wanted to solve the crisis quietly and expeditiously.",
    },
    {
      word: "Improvise",
      definition:
      ...
      sample:
        "The group imrovised a shelter to keep themselves dry under the rain.",
    },
  ];
